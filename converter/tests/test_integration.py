from converter.constants import CSV_TEST_INPUT
from converter.constants import XML_TEST_INPUT
...
def test_integration(tmp_path):
    data_converter = ConvertCsvToXml(orig_csv_path=CSV_TEST_INPUT)
    ...
    pd.testing.assert_frame_equal(left=df_with_errors, right=df_expected_with_errors_dtypes)
    ...
    xml_equals_expected_xml = filecmp.cmp(f1=XML_TEST_INPUT.as_posix(), f2=path_small.as_posix(), shallow=True)
